            ...
            <form id="updateForm" method="post" action="updateBoard.do" enctype="multipart/form-data">
                ...
                <table align="center">
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="file" id="upfile" class="form-control-file border" name="reUploadFile"> <!-- 새로 업로드되는 파일 -->
                            <c:if test="${ !empty b.originName }">
	                                                               현재 업로드된 파일 : ${ b.originName } <br>
	                            <input type="hidden" name="changeName" value="${ b.changeName }"> <!-- input hidden 타입으로 파일 이름이 있다. -->
